...
#creates the Naive Bayes
NaiveBayeModel = GaussianNB()

#run Naive Bayes between x and y value.
NaiveBayeModel.fit(X_train,y_train)

# use logistics regression model and run the prediction on x_test variable
Prediction = NaiveBayeModel.predict(X_test)
